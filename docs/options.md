...
A complete list of all the API features that RetroTxt has permission to access. Please read the [privacy policy](privacy.md) for the information obtained and why.
